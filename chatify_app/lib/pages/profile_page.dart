  ...
  Widget _profilePageUI() {
    return Builder(
      builder: (BuildContext _context) {
        ...
        //streambuilder rebuilds all widgets whenever the app updates itself
        //creates a streambuilder with instance from Contact page
        return StreamBuilder<Contact>(
          stream: DBService.instance.getUserData(_auth.user.uid),
          //inside streambuilder must have a builder which here is _context
          //while we need another async value to be passed into it, in this case its _snapshot
