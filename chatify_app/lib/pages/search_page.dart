  ...
  Widget _userSearchField() {
    return Container(
      ...
      child: TextField(
        ...
        //this updates only when enter is pressed does not search realtime interaction
        onSubmitted: (_input) {
          setState(() {
            //because the _usersListView uses streambuilder when onsubmit the _searchtext is updated
            //so using setState() for streambuilder when updated will rebuild the widget
            _searchText = _input;
          });
        },
  ...
  Widget _usersListView() {
    return StreamBuilder<List<Contact>>(
      ...
      builder: (_context, _snapshot) {
        //returns the context and and data from stream
