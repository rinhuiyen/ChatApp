...
class _ConversationPageState extends State<ConversationPage> {
  ...
  Widget _messageListViewChild(bool _isOwnMessage, Message _message) {
    return Padding(
      ...
      //for every item inside the list split it into a row
      child: Row(
  ...
  Widget _textMessageBubble(
    ...
    List<Color> _colorScheme =
        _isOwnMessage ? [Colors.blue] : [Color.fromRGBO(69, 69, 69, 1)];
    return Container(
  ...
  Widget _imageMessageBubble(
    ...
    Color _colorScheme = _isOwnMessage ? Colors.blue : Colors.green;
