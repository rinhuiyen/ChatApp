...
class AuthProvider extends ChangeNotifier {
  //FirebaseAuth interacts with firebase authentication
  //latest ver (0.18.0) to use FirebaseUser is:
  /*void inputData() {
  ...
  void _autoLogin() async {
    if (user != null) {
      //becuase firebaseauth returns a future thus need async and await
  ...
  void loginUserWithEmailAndPassword(String _email, String _password) async {
    ...
    notifyListeners();
    try {
      //AuthResult = Contains a method that returns the currently signed-in user after the operation has completed.
